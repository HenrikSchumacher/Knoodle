 ...
 *  _Caution:_ This routine is equivalent to `PlanarDiagram<Int>::Private_Reidemeister_I`, except that it uses the modified routine `StrandSimplifier2<Int>::Reconnect` that is equivalent to `PlanarDiagram<Int>::Reconnect` except that it makes modified arcs by `PlanarDiagram<Int>::TouchArc`!
 *
