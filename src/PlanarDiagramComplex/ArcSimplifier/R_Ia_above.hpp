        ...
        if(o_0 == o_3)
        {
            ...
            if constexpr ( mult_compQ )
            {
                ...
                if(w_3 == n_3)
                {
                    ...
                    PD_NOTE(MethodName("R_Ia_above")+": Disconnect a Hopf link. ( crossing_count = " + ToString(pd.crossing_count) + ")");
...
//            ++pd.R_Ia_counter;
        ...
        else // if(o_0 != o_3)
        {
            ...
            if( w_0 == w_3 )
            {
                ...
                {
                    PD_PRINT("\t\t\t\t\tn_3 == e_1");
                    PD_NOTE(MethodName("R_Ia_above")+": Split a trefoil. ( crossing_count = " + ToString(pd.crossing_count) + ")");
                ...
                PD_NOTE(MethodName("R_Ia_above")+": Disconnect a trefoil. ( crossing_count = " + ToString(pd.crossing_count) + ")");
    ...
    if constexpr( mult_compQ )
    {
        ...
        if(w_3 == n_1)
        {
            ...
            PD_NOTE(MethodName("R_Ia_above")+": Disconnect a Hopf link and another subdiagram. ( crossing_count = " + ToString(pd.crossing_count) + ")");
