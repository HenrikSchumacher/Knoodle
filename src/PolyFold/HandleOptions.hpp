...
void HandleOptions( int argc, char** argv )
{
    ...
    ("macleod-code,M", "Compute _short_ MacLeod codes (i.e., 1 number per crossing) and print them to file \"MacLeodCodes.txt\".")
    ...
    ("clisby-pivots", "Sample u uniformly on [1,floor(n/2)+1], then take pivot distance d = floor(2^u).")
