...
//            PrintInfo();
        ...
        Prosector_Boost & operator=( const Prosector_Boost & other ) = default;
        // Move constructor
        Prosector_Boost( Prosector_Boost && other ) = default;
