...
//    TOOLS_DUMP( sizeof(Tools::CachedObject::Container_T) );
//    TOOLS_DUMP( sizeof(Tools::CachedObject::ReadLock_T) );
//    TOOLS_DUMP( sizeof(Tools::CachedObject::WriteLock_T) );
//    TOOLS_DUMP( sizeof(Tools::CachedObject::Mutex_T) );
