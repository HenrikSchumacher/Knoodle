...
/*!
 * @brief Attempts to simplify the planar diagram by applying some local moves implemented by the `ArcSimplifier_Legacy` class. Returns an estimate on the number of changes made.
 *
 ...
 *  See the ASCII-art in the implementation of the class `ArcSimplifier_Legacy` for more details.
 *
...
Size_T simplify3( Size_T max_iter )
{
    ...
    ArcSimplifier_Legacy<Int,optimization_level,multi_compQ> arc_simplifier (*this);
